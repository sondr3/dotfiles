...
you should place your code here."
  ...
  (defun my-tangle-dotfiles ()
    ...
    (when (and (equal (file-name-directory (directory-file-name buffer-file-name))
      ...
      (org-babel-tangle)
      (message "Tangled %s" buffer-file-truename)))
