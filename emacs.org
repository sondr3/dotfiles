...
#+END_SRC
*** Spaceline
There's a few other mode line packages out there, but this is by far the one
that looks best out of the box and since it has the full weight of Spacemacs
behind it it'll always be updated. Neat.
#+BEGIN_SRC emacs-lisp
