...
frame, or switch between the last used buffer and this one.
...
#+BEGIN_SRC emacs-lisp
  ...
  (leader-keys "TAB" '(my--switch-window :which-key "window")
               "b TAB" '(my--switch-buffer :which-key "<->"))
#+END_SRC
** evil-mode
...
#+BEGIN_SRC emacs-lisp
  (use-package evil
    ...
    :config (evil-mode t)
    :general
    (leader-keys "f" '(:which-key "files")
                 "fs" '(evil-write :which-key "save buffer")
...
#+BEGIN_SRC emacs-lisp
  (use-package flyspell-correct-ivy
    ...
    :general
    (leader-keys "S" '(:ignore t :which-key "spelling")
                 "Sb" '(flyspell-buffer :which-key "spellcheck buffer")
                 "Sc" '(flyspell-correct-previous-word-generic :which-key "correct spelling")
                 "Sn" '(flyspell-goto-next-error :which-key "next spelling error"))
...
#+BEGIN_SRC emacs-lisp
  (use-package counsel
    :delight
    :general
    (leader-keys ";" '(counsel-M-x :which-key "M-x")
  ...
  (use-package ivy
    :delight
    :general
    (leader-keys "b" '(:which-key "buffers")
  ...
  (use-package swiper
    :general
    (leader-keys "s" '(:which-key "search")
