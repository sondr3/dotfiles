...
And then we can begin to set some initial keybindings.

#+BEGIN_SRC emacs-lisp
  (my-bindings "fs" '(save-buffer :which-key "save buffer")
               "fS" '(save-some-buffers t :which-key "save all buffers"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package flyspell-correct-ivy
    ...
    :general
    (my-bindings "S" '(:ignore t :which-key "spelling")
...
#+BEGIN_SRC emacs-lisp
  (use-package counsel
    :delight
    :general
    (my-bindings ";" '(counsel-M-x :which-key "M-x")
                 "f" '(:which-key "files")
  ...
  (use-package ivy
    :delight
    :general
    (my-bindings "b" '(:which-key "buffers")
  ...
  (use-package swiper
    :general
    (my-bindings "s" '(:which-key "search")
