...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-main-menu (:color pink
                                    :hint nil)
    "
  ^Save^             ^Search^           ^Actions^          ^Search
  ^^^^^^^^-----------------------------------------------------------------
  _s_: save          _f_: unmark        _x_: execute       _R_: re-isearch
  _S_: save all      _F_: unmark up     _b_: bury          _I_: isearch
  "
    ("s" save-buffer :color blue)
    ("S" evil-write-all :color blue)
...
#+BEGIN_SRC emacs-lisp
  ...
  "
    ...
    ("S" magit-stage-file :color blue)
    ("c" magit-commit-popup :color blue)
    ("d" magit-diff-popup :color blue)
    ("D" magit-diff-head :color blue)
    ("p" magit-push-popup :color blue)
    ("l" magit-log-popup :color blue))
#+END_SRC
* Programming
