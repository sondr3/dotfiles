...
#+END_SRC
** Mode line
We'll switch to something a bit more fancy than the default mode line, however
we do need to hide a few minor modes because they are quite frankly incredibly
annoying to look at. Normally, you'd use diminish for this but we're going to be
using delight because it also supports major modes.
