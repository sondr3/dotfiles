...
| ~undo-tree-mode~                     | ~nil~             | ~Dim~ settings        |
...
#+END_SRC
* Keybindings
I tried, I really tried to use Emacs without using Evil, but I just can't get
over how much better and more intuitive it feels to use Vim keybindings over the
Emacs one. So I'll install it again... and again...
