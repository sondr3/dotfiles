...
using Linux...
#+BEGIN_SRC emacs-lisp
  (use-package elpy :ensure t :config (elpy-enable) (setq
    elpy-rpc-python-command "python3") (elpy-use-cpython "python3") (setq
    python-shell-interpreter "python3")) #+END_SRC
* Org mode
