;;; am-org.el --- Amalthea Org-mode configuration -*- lexical-binding: t -*-
...
;;; Add the org-mode configuration to load-path
(eval-and-compile
  (add-to-list 'load-path amalthea-org-dir t))

(require 'am-org-agenda)
(require 'am-org-beamer)
(require 'am-org-bindings)
(require 'am-org-capture)
(require 'am-org-latex)
